                    ...
                    while let Some(event) = event_rx.recv().await {
                        ...
                        match event {
                            ...
                            RoomEvent::ConnectionStateChanged(state) => {
                                info!("PongService {} connection state changed: {:?}", service_name, state);
                            }
                            ...
                            _ => {
                                ...
                                debug!("PongService {} received other event: {:?}", service_name, event);
                            }
                        }
                    }
...
pub async fn start_pong_service(
    ...
    info!("Starting PongService microservice on port {}...", service_port);
